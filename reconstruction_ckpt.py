    ...
    while True:
        ...
        for image, _ in candidates:
            ...
            if should_retriangulate.should():
                ...
                logger.info("Checkpoint: saved reconstruction.json after global bundle+retriangulate")
                ...
                should_bundle.done()
                data.save_reconstruction([reconstruction])
                logger.info("Checkpoint: saved reconstruction.json after global bundle")
